...
const Hero = () => {
  ...
  return (
    <>
      <div id='About' className=' grid grid-cols-2 mx-4 lg:mx-20  overflow-hidden relative   '>
      ...
      <Image src="/me.png" alt="me" width={300} height={300} className='h-16 w-22 object-cover rounded-full border-2 lg:border-4 border-main' />

    </div>
          </div>
          <TextAnimation Class="text-xl lg:text-3xl font-semibold text-center mb-2 lg:mb-3 handFont" text={titleOne} />
          <TextAnimation Class="text-base lg:text-xl font-medium text-center handFont" text={titleTwo} />
